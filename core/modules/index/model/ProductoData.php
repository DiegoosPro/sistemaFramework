...
public static function updateProducto($pro_id,$pro_descripcion, $pro_precio_c,$pro_precio_v,
$pro_stock,$pro_fecha_elab,$pro_nivel_azucar, $pro_aplica_iva,
$pro_especifica, $pro_imagen, $marca_id, $catego_id )
{ 
  try {
    $sql = "UPDATE tab_productos SET pro_descripcion=:ppro_descripcion,
    ...
    marca_id=:pmarca_id,
    catego_id=:pcatego_id WHERE pro_id=:ppro_id";
